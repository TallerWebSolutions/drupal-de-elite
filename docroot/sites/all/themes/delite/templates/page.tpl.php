 ...
 */
// print_r(arg(0, drupal_get_path_alias()));
?>
...
<div id="wrap" class="clearfix">
  ...
  <div id="main" class="clearfix">
    ...
    <?php if ($is_front): ?>
    <?php if (theme_get_setting('slideshow_display','delite')): ?>
      <?php 
      $slide1_head = theme_get_setting('slide1_head','delite'); $slide1_desc = theme_get_setting('slide1_desc','delite'); 
      $slide2_head = theme_get_setting('slide2_head','delite'); $slide2_desc = theme_get_setting('slide2_desc','delite'); 
      $slide3_head = theme_get_setting('slide3_head','delite'); $slide3_desc = theme_get_setting('slide3_desc','delite'); 
   ...
   <div id="slider-wrap">
    <div id="home-slides" class="slides clearfix">
      <div class="slides_container">
        <div class="slide">
           <img src="<?php print base_path() . drupal_get_path('theme', 'delite') . '/images/slide-image-1.jpg'; ?>" height="350" width="660"/>
        ...
        <div class="slide">
           <img src="<?php print base_path() . drupal_get_path('theme', 'delite') . '/images/slide-image-2.jpg'; ?>" height="350" width="660"/>
        ...
        <div class="slide">
           <img src="<?php print base_path() . drupal_get_path('theme', 'delite') . '/images/slide-image-3.jpg'; ?>" height="350" width="660"/>
  ...
  <div id="copyright" class="clearfix">
    ...
    <div class="one-half column-last" id="credit">
       <?php print t('Developed by <a href="http://taller.net.br">Taller Web Solutions</a>.'); ?>
    </div>
  </div>
</div>
